// Edited to fit PiGfx by Christian Lehner 2020
/*
	------------------------------------------------------------------------------
...
void c2Dual(c2Poly* poly, float skin_factor, c2Poly* output)
{
	c2Poly dual;
    ...
    memcpy(output, &dual, sizeof(dual));
}
...
void c2InflatePoly(c2Poly* poly, float skin_factor)
{
...
void c2Inflate(void* shape, C2_TYPE type, float skin_factor)
{
	...
	{
		c2Poly* poly = (c2Poly*)shape;
		c2InflatePoly(poly, skin_factor);
	}	break;
    case C2_TYPE_NONE: break;
	}
}
